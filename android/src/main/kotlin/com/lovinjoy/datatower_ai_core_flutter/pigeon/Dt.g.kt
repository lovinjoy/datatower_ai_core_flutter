...
private fun wrapError(exception: Throwable): List<Any?> {
  if (exception is DtFlutterError) {
    return listOf(
      exception.code,
      exception.message,
      exception.details
...
interface DTPigeon {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: DTPigeon?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.datatower_ai_core_flutter.DTPigeon.initSDK", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            try {
              api.initSDK(appIdArg, urlArg, channelArg, isDebugArg, logLevelArg, commonPropertiesArg)
