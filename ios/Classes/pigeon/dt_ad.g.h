...
- (void)reportPaidId:(NSString *)id type:(DTAdTypeDart)type platform:(DTAdPlatformDart)platform location:(NSString *)location seq:(NSString *)seq value:(NSString *)value currency:(NSString *)currency precision:(NSString *)precision properties:(NSDictionary<NSString *, id> *)properties entrance:(NSString *)entrance mediation:(DTAdMediationDart)mediation mediationId:(NSString *)mediationId error:(FlutterError *_Nullable *_Nonnull)error;
